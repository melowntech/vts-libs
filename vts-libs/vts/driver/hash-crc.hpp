#ifndef vadstena_libs_vts_driver_hash_crc_hpp_included_
#define vadstena_libs_vts_driver_hash_crc_hpp_included_
...
#endif // vadstena_libs_vts_driver_hash_crc_hpp_included_
