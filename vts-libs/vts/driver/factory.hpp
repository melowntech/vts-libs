#ifndef vadstena_libs_vts_driver_factory_hpp_included_
#define vadstena_libs_vts_driver_factory_hpp_included_
...
#endif // vadstena_libs_vts_driver_factory_hpp_included_
